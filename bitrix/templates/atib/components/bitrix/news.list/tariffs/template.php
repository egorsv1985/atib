	...
	<div class="grid grid-cols-3 gap-x-7 gap-y-5 mb-11">
		...
		<div class="col-span-3 lg:col-span-2 -order-1 lg:order-0">
			<div class="flex items-center justify-between ">
				...
				<!-- Modal toggle -->
				<button data-modal-target="question-modal" data-modal-toggle="question-modal" class="flex gap-3" type="button">
					<span class="flex items-center justify-center w-10 h-10 border rounded-full border-gray_border bg-gray_500"><img src="<?= SITE_TEMPLATE_PATH ?>/images/icons/question.svg" alt="question" /></span>
