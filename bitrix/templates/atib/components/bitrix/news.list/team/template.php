...
<section class="py-12 team">
	...
	<div class="grid grid-cols-12 mb-10">
		<div class="col-span-12 lg:col-span-5">
			...
			<div class="">
				<p class="text-xl leading-tight text-txt ">Знакомьтесь с людьми, которые делают ваш проект
					возможным</p>

			</div>
		</div>
	</div>
	<div class="gap-5 md:grid md:grid-cols-3 lg:grid-cols-4 team__slider slider">
		...
		?>
			<div class="mr-8 slider__item sm:mr-0  ">
				<div class="p-5 rounded-[10px] h-full border border-gray_border mb-2 bg-gray_light max-w-64 mx-auto">
