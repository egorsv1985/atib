		...
		<div class="grid grid-cols-12 py-4 border-t gap-7 border-t-gray_border">
			<div class="col-span-12 lg:col-span-5">
				...
				<div class="flex flex-wrap items-center justify-center gap-7 sm:justify-between sm:gap-1">
					...
					<div class="">
						<img src="<?= SITE_TEMPLATE_PATH ?>/images/icons/Белкарт Интернет.svg" alt="Белкарт Интернет" class="" />
					</div>
				</div>
			</div>
		...
		<div class="relative bg-gray_light rounded-[10px] py-10 px-24">
			...
			<form class="flex flex-col" action="#">
				...
				<div class="grid grid-cols-2 mb-6 gap-x-7 gap-y-5">
					...
					<div class="col-span-2 lg:col-span-1">
						<div>
							...
							<input type="mail" name="mail" id="mail" placeholder="Почта*" class="block w-full p-4 text-base leading-tight border rounded-md focus:border-white/50 focus:ring-white/50 focus:outline-none bg-gray_light border-gray_border text-txt" required="" />
						</div>
					</div>
					<div class="col-span-2 lg:col-span-1">
						<div>
				...
				<div class="mb-3">
					...
					<textarea  name="message" id="message" placeholder="Описание" class="block w-full p-4 text-base leading-tight border rounded-md focus:border-white/50 focus:ring-white/50 focus:outline-none bg-gray_light border-gray_border text-txt" required="" />
				</div>
				<div class="mb-6">
